...
//             <section>
//               <Link href="/diensten#com-mobile" style={{ textDecoration: "none" }}>
...
//             </section>
//             <section>
//               <Link style={{ textDecoration: "none" }} href="/diensten#com-ondersteuning">
//                 <div className="content btn-highlights">
//                   <span className="flex w-full flex-col items-center justify-center gap-4">
...
//             </section>
//             <section>
//               <Link href="/diensten#com-advies" style={{ textDecoration: "none" }}>
//                 <div className="content btn-highlights">
//                   <span className="flex w-full flex-col items-center justify-center gap-4">
