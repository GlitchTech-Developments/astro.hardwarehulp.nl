          ...
          <div className="row">
            <div className="col-12 col-12-medium">
                ...
                <table>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="hidden-mob">Computer op maat gebouwd bij u thuis.</td>
                      <td>80,-</td>
                      <td>Computer</td>
                    </tr>
                    <tr>
                      ...
                      <td className="hidden-mob">
                        Installatie van apparatuur zoals computers, laptops, speakers, printer etc.
                      </td>
                      <td>40,-</td>
                      <td>afspraak</td>
                    </tr>
                    <tr>
                      ...
                      <td className="hidden-mob">
                        Advisering van de aankoop van elektronica zoals computers, laptops,
                        smartphones etc.
                      </td>
                      <td>20,-</td>
                      <td>afspraak</td>
                    ...
                    <tr>
                      ...
                      <td className="hidden-mob">
                        Technische ondersteuning bij hardware en softwarematige zaken zoals
                        opschonen van uw computer/laptop en nog veel meer.
                      </td>
                      <td>30,-</td>
                      <td>uur **</td>
                    </tr>
              ...
              <div className="Tarieven-uitleg">
                ...
                >
                  Windows licenties zijn alleen aan te schaffen bij een computer op maat of
